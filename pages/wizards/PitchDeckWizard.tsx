...
const steps = [
  { id: 'goal', title: 'Round Goal', q: 'How much are you raising and what is the stage (e.g., $1.5M Seed)?' },
  { id: 'audience', title: 'Target Audience', q: 'Which types of investors are you pitching to (VCs, Angels, Strategic)?' },
  { id: 'emphasis', title: 'Strategic Focus', q: 'Does this deck focus more on early traction or long-term vision?' },
];
    ...
    <div className="min-h-[80vh] flex items-center justify-center p-6 bg-[#FDFCFB]">
      <div className="max-w-2xl w-full bg-white rounded-[60px] p-16 soft-shadow border border-gray-50 relative overflow-hidden">
        ...
        <header className="mb-12">
          <span className="text-[10px] font-bold text-indigo-400 uppercase tracking-[0.3em] mb-2 block">Wizard — Narrative Design</span>
        ...
        <div className="space-y-8">
          ...
          <div className="flex items-center justify-between gap-6">
            ...
            >
              {currentStep === steps.length - 1 ? 'Generate Story' : 'Continue'}
            </button>
          </div>
        </div>
      </div>
